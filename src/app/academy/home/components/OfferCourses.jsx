...
const CourseCard = ({ course }) => {
  ...
  return (
    <div className="bg-body shadow rounded-3 text-center p-4 position-relative">
      <img src={image} className="h-100px mb-3" alt="course-image" />
      <h5 className="mb-2">
        <Link to="" className="stretched-link" style={{ pointerEvents: 'none', cursor: 'default', textDecoration: 'none', color: 'inherit' }}>
          {title}
        </Link>
      </h5>
      ...
      <Container className="position-relative py-5">
        <Row>
          <Col lg={8} className="mb-4">
            ...
            <p className="mb-0">Program Highlights</p>
          </Col>
        </Row>
