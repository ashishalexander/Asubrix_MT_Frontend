...
import { FaUser, FaEnvelope, FaPhone, FaGraduationCap, FaCalendar, FaBriefcase, FaBook, FaUserCircle, FaUpload } from 'react-icons/fa';
...
const FacultyForm = ({ faculty, onSubmit }) => {
  ...
  const subjectOptions = [
    ...
    { id: 4, name: 'Statistical Analysis' },
    { id: 5, name: 'Front-end Development' },
    { id: 6, name: 'UI/UX Design' },
    { id: 7, name: 'SQL Advanced' },
    { id: 8, name: 'NoSQL Databases' },
    { id: 9, name: 'Network Security' },
    { id: 10, name: 'Ethical Hacking' },
      ...
      <Row className="mb-4">
        ...
        <Col md={9}>
          <Row className="g-3">
            ...
            <Col md={12}>
              <Form.Group controlId="facultySubjects">
