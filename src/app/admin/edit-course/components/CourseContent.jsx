...
import { 
  ...
  FiDownload, FiUpload, FiLink, FiX, FiArrowLeft
} from 'react-icons/fi';
...
const CourseContent = ({ setActiveStep, setProgress }) => {
  ...
  const handleAddVideoModule = () => {
    if (moduleName && chapters.length > 0) {
      ...
      if (moduleToUpdate) {
        ...
        setVideoModules(videoModules.map(module => 
    ...
    <div onClick={(e) => e.stopPropagation()} className="ms-auto">
      <Dropdown align="end">
        ...
        <Dropdown.Menu className="shadow-sm border-0">
          ...
          <Dropdown.Item 
            onClick={(e) => handleContentAction('delete', content.id, parentId, e)}
    ...
    <div onClick={(e) => e.stopPropagation()} className="ms-auto">
      <Dropdown align="end">
        ...
        <Dropdown.Menu className="shadow-sm border-0">
          ...
          <Dropdown.Item 
            onClick={(e) => handleModuleAction('delete', module.id, e)}
            className="text-danger"
          >
            <FiTrash2 className="me-2" /> Delete
          </Dropdown.Item>
          ...
          <Offcanvas.Body>
            {!contentType ? (
              <Button
                ...
                onClick={() => setDrawerMode('add-content')}
              >
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      ...
                      accept={
                        ...
                        contentType === 'archive' ? '.zip,.rar,.7z' :
                        '*/*'
                      }
                    />
  ...
  return (
    <div>
      ...
      {/* Video Module Drawer */}
      <Offcanvas 
        show={showVideoModuleDrawer} 
        onHide={() => setShowVideoModuleDrawer(false)}
        placement="end"
        style={{ width: '600px' }}
      >
        <Offcanvas.Header closeButton>
        ...
        <Offcanvas.Body>
          <Form>
            ...
            <Button
              ...
              disabled={!moduleName || chapters.length === 0}
            >
              Save Module
            </Button>
          </Form>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <div className="d-flex gap-2">
          <Button
            ...
            onClick={() => setShowVideoModuleDrawer(true)}
          >
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center flex-grow-1">
                        ...
                        <div className="flex-grow-1">
                          ...
                          {content.type === 'link' && (
                            <small className="text-muted d-block">{content.url}</small>
                          )}
                        </div>
                      </div>
                      <Button
            ...
            <div className="video-modules-list">
              {videoModules.map(module => (
                <div key={module.id} className="mb-4">
                  <div className="d-flex align-items-center mb-3">
                    <h4 className="mb-0">{module.moduleName} ({module.chapters.length} lectures)</h4>
                    <Button
                      variant="link"
                      className="p-0 ms-3 text-primary"
                      onClick={(e) => handleModuleAction('edit', module.id, e)}
                    >
                      <FiEdit2 size={18} />
                    </Button>
                  </div>
                            ...
                            <div className="d-flex align-items-center flex-grow-1">
                              ...
                              <div className="flex-grow-1">
                                ...
                                <small className="text-muted d-block">
                                  {chapter.videoType === 'upload' ? 'Uploaded Video' : 'YouTube Video'}
                                </small>
                              </div>
                            </div>
                            <Button
