      ...
      <Container>
        ...
        <Row className="g-4 mt-0 mt-lg-5">
          <Col xs={6} md={4}>
            <Row className="g-4">
              <Col xs={10} lg={6}>
                <img className="rounded-4" src={about5} alt="about" />
              </Col>
              <Col xs={12}>
                <img className="rounded-4" src={about3} alt="about" />
              </Col>
            </Row>
          </Col>
          <Col xs={6} md={4} className="position-relative">
            ...
            <img className="rounded-4" src={about9} alt="about" />
          </Col>
          <Col md={4}>
            <Row className="g-4">
              <Col sm={6} md={12}>
              ...
              <Col sm={6} md={12} lg={6}>
                <img className="rounded-4" src={about10} alt="about10" />
              </Col>
            </Row>
          </Col>
        </Row>
