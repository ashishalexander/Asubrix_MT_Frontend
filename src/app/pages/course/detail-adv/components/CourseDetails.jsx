            ...
            {activeTab === 'description' && (
              <>
                ...
                <ul className="list-unstyled">
                  <li><FaCheckCircle className="text-success me-2" /> 100+ Interactive Sessions</li>
                  <li><FaCheckCircle className="text-success me-2" /> Duration: 1 Year</li>
                  <li><FaCheckCircle className="text-success me-2" /> Weekend Classes - 2 Hours/Day</li>
                  <li><FaCheckCircle className="text-success me-2" /> Pre-Recorded Videos of NCERT Books</li>
                  <li><FaCheckCircle className="text-success me-2" /> 5000+ Practice Questions</li>
                  <li><FaCheckCircle className="text-success me-2" /> 10+ Webinars</li>
                  <li><FaCheckCircle className="text-success me-2" /> One-Time Course Fee</li>
                  <li><FaCheckCircle className="text-success me-2" /> Topper's Study Materials</li>
                  <li><FaCheckCircle className="text-success me-2" /> 1-1 Mentorships</li>
                </ul>
              </>
            )}
