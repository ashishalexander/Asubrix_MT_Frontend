  ...
  return <Row className="g-4">
      <Col lg={6}>
        ...
        <div className="d-flex align-items-center mb-3">
          ...
          <div>
            <ul className="list-inline mb-0">
              {Array(Math.floor(4)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small">
                    <FaStar size={14} className="text-warning" />
                  </li>)}
              {!Number.isInteger(4) && <li className="list-inline-item me-1 small">

                  <FaStarHalfAlt size={14} className="text-warning" />
                </li>}
              {4 < 5 && Array(5 - Math.ceil(4)).fill(0).map((_star, idx) => <li key={idx} className="list-inline-item me-1 small">
                      <FaRegStar size={14} className="text-warning" />
                    </li>)}
            </ul>
            <p className="mb-0">Review from our students </p>
