  ...
  return (
    <Card className="shadow-hover overflow-hidden bg-transparent border border-light">
      <div className="position-relative">
        <img className="card-img-top" src={"https://cdn.prod.website-files.com/615fe732842b1953eb640cc2/64998eac013d863c5c51aab2_Foundation-course-Thumbnail.png"} alt="Card image" />
        ...
        <Row className="mb-4">
          <Col xs={6}>
            <h2 className="fs-1 fw-bold">
              <span className="position-relative z-index-9">Featured</span>&nbsp;
