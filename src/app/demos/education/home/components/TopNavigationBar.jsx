  ...
  return <TopNavbar>
      <Container>
        ...
        <Dropdown drop="start" className="ms-1 ms-lg-0">
          <DropdownToggle as={Link} className="avatar avatar-sm p-0 arrow-none" to="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
