...
export const MenuItem = ({ item, linkClassName, level }) => {
  return (
    <>
      <li>
...
const AppMenu = ({ mobileMenuOpen, menuClassName, showExtraPages, showCategories, searchInput, showMegaMenu, startSearchInput }) => {
